...
**The components only work in conjunction with a custom H5P server using
[@lumieducation/h5p-server](https://www.npmjs.com/package/@lumieducation/h5p-server)**.
...
### Callbacks of H5PPlayerComponent
...
### Callbacks of H5PEditorComponent
