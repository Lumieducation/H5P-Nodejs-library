...
export default class H5PConfig implements IH5PConfig {
    ...
    public async load(): Promise<H5PConfig> {
        ...
        await this.loadSettingFromStorage('coreApiVersion');
        ...
        await this.loadSettingFromStorage('h5pVersion');
    ...
    public async save(): Promise<void> {
        ...
        await this.saveSettingToStorage('coreApiVersion');
        ...
        await this.saveSettingToStorage('h5pVersion');
